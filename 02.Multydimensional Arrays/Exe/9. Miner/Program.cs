            ...
            foreach (var d in directions)
            {
                if (d == "up" && currentR - 1 >= 0)
                {
                    ...
                    if (field[currentR, currentC] == 'c')
                    {
                        ...
                        if (coals == 0)
                        { 
                            Console.WriteLine($"You collected all coals! ({currentR}, {currentC})"); return;
                        }
                    }
                    else if (field[currentR, currentC] == 'e')
                    {
                        Console.WriteLine($"Game over! ({currentR}, {currentC})"); return; 
                    }
                }
